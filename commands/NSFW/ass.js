...
module.exports = {
  ...
  run: async(client, msg, args) => {
    ...
    if(!msg.channel.nsfw) return msg.channel.send("Please fap in a NSFW channel, not here.");
  ...
  .setFooter(`Requested by ${msg.member.user.tag} at ${msg.createdAt.toDateString()}`);
